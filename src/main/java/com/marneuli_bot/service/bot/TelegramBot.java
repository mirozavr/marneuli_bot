...
import com.marneuli_bot.service.brands.CarBrandInfoSell;
import com.marneuli_bot.service.brands.CarModelInfoSell;
import com.marneuli_bot.service.brands.CategoryInfoBuy;
import com.marneuli_bot.service.brands.CategoryInfoSell;
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    //////////////////////////// CAR LOGIC
    /// Car Brand
    private long tempCarBrandId5;
    private String tempCarBrandName5;


    /// Car Model
    private long tempCarModelId5;
    private CarBrands carBrands5;
    private CarModels carModels5;

    private String tempCarModelName5;
    /// Car Sell
   ...
   private Sostoyanie sostoyanie5;
    ...
    public void onUpdateReceived(Update update) {
      ...
      // carModels7.setModel();
        ...
        carBrands7.setId(tempCarBrandId5);
        ...
        if (update.hasCallbackQuery()) {
           ...
           //       List<Order> userOrders = orderRepository.findByUserId(userId);
                    ...
                    if (update.getCallbackQuery().getData().equals(categoryInfo.getCategory())) {
                        ...
                        if (tempCatIdSell == 1) {
                            ...
                            for (CarBrands carBrands1 : carBrandsList) {
                                ...
                                tempCarBrandId5 = carBrands1.getId();
            ...
            else if (update.hasCallbackQuery() && sos == sostoyanie.chooseCarModel) {
                String chatId = update.getCallbackQuery().getMessage().getChatId().toString();
                ...
                for (CarBrandInfoSell carBrandInfoSell : carBrandsList) {
                    if (update.getCallbackQuery().getData().equals(carBrandInfoSell.getBrand())) {
                        ...
                        for (CarModels carModels : carModelsList) {
                            if (carModels.getCarBrands().getId() == tempCarBrandId5) {
                                InlineKeyboardButton button = new InlineKeyboardButton();
                                List<InlineKeyboardButton> row = new ArrayList<>();
                                button.setText(carModels.getModel());
                                button.setCallbackData("car_model:" + carModels.getId());
                ...
                for (CarModelInfoSell carModelInfoSell : carModelsList) {
                    ...
                    tempCarModelId5 = carModelInfoSell.getId();
                    tempCarModelName5 = carModelInfoSell.getModel();
                    carModels7.setId(tempCarModelId5);
                ...
                System.out.println(tempCarModelId5);
            }
            /////////////////// Логика покупки
           ...
           /* if (sos == sostoyanie.chooseCarBrand ) {
                //TODO
            }*/
    ...
    private void saveCarInDb(CarSelling carSelling, long orderId) {
        ...
        carSelling.setCarModels(tempCarModelId5);
        carSelling.setCarBrands(carBrands5);
        carSelling.setOrderId(orderId);
        carService.saveCar(tempYearOfIssue5, "неизвестно", tempCarModelId5, carBrands5, orderId);
    ...
    public class Sostoyanie {
        ...
        private final int chooseCarBrand = 26;
        private final int chooseCarModel = 27;
